...
export const BOOK_RECOMMENDATIONS: BookRecommendation[] = [
  {
    title: t('Meditations'),
    author: t('Marcus Aurelius'),
    year: t('c. 180 AD'),
    keyIdea:
      t('You do not control what happens to you, only how you answer it — and that is where all your freedom sits.'),
    tags: ['gerer_stress', 'confiance_en_soi'],
  },
  {
    title: t('The Enchiridion'),
    author: t('Epictetus'),
    year: t('c. 125 AD'),
    keyIdea:
      t('Some things are up to us and some are not. Calm begins when you stop confusing the two.'),
    tags: ['gerer_stress', 'routine_stable'],
  },
  {
    title: t('Letters from a Stoic'),
    author: t('Seneca'),
    year: t('c. 65 AD'),
    keyIdea: t('We suffer more often in imagination than in reality — most of what we fear never arrives.'),
  ...
  },
  {
    ...
    year: '1854',
    keyIdea: t('Simplifying your life is how you finally give yourself the time to look at it.'),
    tags: ['reduire_ecrans', 'routine_stable'],
  },
  {
    title: t('Tao Te Ching'),
    author: t('Laozi'),
    year: t('c. 4th century BC'),
    keyIdea: t('Yielding often beats rigidity, the way water wears down stone without ever forcing it.'),
  ...
  },
  {
    ...
    year: '1580',
    keyIdea: t('Knowing yourself is the first step towards choosing who to let into your life.'),
